...
public struct sQuaternion : IEquatable<sQuaternion>, IFormattable
{
	...
	public static explicit operator Quaternion(sQuaternion q) { return new Quaternion((float)q.x, (float)q.y, (float)q.z, (float)q.w); }
	public static explicit operator sQuaternion(Quaternion q) { return new sQuaternion((sfloat)q.x, (sfloat)q.y, (sfloat)q.z, (sfloat)q.w); }
	//
	// 요약:
