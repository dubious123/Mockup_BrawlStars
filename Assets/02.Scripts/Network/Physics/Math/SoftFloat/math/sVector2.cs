...
public struct sVector2 : IEquatable<sVector2>, IFormattable
{
	...
	public static explicit operator Vector2(sVector2 v) { return new Vector2((float)v.x, (float)v.y); }

	public static explicit operator sVector2(Vector2 v) { return new sVector2((sfloat)v.x, (sfloat)v.y); }
