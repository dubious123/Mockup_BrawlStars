...
public struct sVector3 : IEquatable<sVector3>, IFormattable
{
	...
	public static explicit operator Vector3(sVector3 v) { return new Vector3((float)v.x, (float)v.y, (float)v.z); }

	public static explicit operator sVector3(Vector3 v) { return new sVector3((sfloat)v.x, (sfloat)v.y, (sfloat)v.z); }
